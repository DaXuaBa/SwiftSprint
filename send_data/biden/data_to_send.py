...
conf_file_name = "X:\\2023-24\\Nam_4_HK2\\github\SwiftSprint\\send_data\\biden\\stream_app.conf"
...
if __name__ == "__main__":
    ...
    data = pd.read_csv("X:\\2023-24\\Nam_4_HK2\\hashtag_joebiden.csv", usecols=['tweet', 'state', 'state_code'], index_col=None, header=0, engine='python')
